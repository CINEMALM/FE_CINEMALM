...
const AdminConcessionSales = lazy(
  () => import("../pages/admin/AdminConcessionSales"),
);
...
const AdminTicketRecovery = lazy(
  () => import("../pages/admin/AdminTicketRecovery"),
);
